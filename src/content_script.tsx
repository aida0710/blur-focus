...
class BlurFocusManager {
  ...
  private handleMouseOver = (event: MouseEvent): void => {
    ...
    while (currentElement && currentElement !== document.body) {
      if (currentElement.classList.contains('blur-focus-element')) {
    ...
    if (this.hoveredElement) {
      ...
      while (element && element !== document.body) {
        if (element.classList.contains('blur-focus-element')) {
          element.classList.remove('blur-focus-hover');
        }
    ...
    blurElements.forEach(element => {
      element.classList.add('blur-focus-hover');
    });
  };
  ...
  private handleMouseOut = (event: MouseEvent): void => {
    ...
    if (relatedTarget) {
      ...
      while (checkElement && checkElement !== document.body) {
        if (checkElement.classList.contains('blur-focus-element')) {
